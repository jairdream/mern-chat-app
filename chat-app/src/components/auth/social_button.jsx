/**
 *
 * This Component is for the Authentication button
 * For the Google Login Button
 */

export const SocialButton = ({ label }) => {
  return (
    <div className="p-3 rounded-xl border-[1px] border-gray-500/50 w-full flex items-center cursor-pointer transition-all ease-in-out duration-300 hover:shadow-[0px_0px_10px_white]">
      <svg
